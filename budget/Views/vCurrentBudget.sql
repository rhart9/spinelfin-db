...
CREATE VIEW [budget].[vCurrentBudget] AS
	SELECT cb.CurrentBudgetID, bi.BudgetItemID, bi.Name, cb.BudgetAmount, cb.BudgetAmount5Week, cb.MatchAmount, cb.MatchAmount5Week, a.AccountName, cb.AmountFrequency, cb.ReconFrequency
